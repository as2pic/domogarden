...
void P8_n8PopCallback(void *ptr) // Réglage Durée Zone 5
{
    SetArrosageType = 9;
}

void P8_n9PopCallback(void *ptr) // Réglage Durée Zone 6
{
    SetArrosageType = 10;
}
...
void SetArrosage(void)
{
        ...
        switch (SetArrosageType)
    {
          ...
          case 9: // Réglage Durée Zone 5
            ...
            EEPROM.writeDouble(addr_t_z5, t_z5);
            P8_n8.setValue(t_z5);
          break;

          case 10: // Réglage Durée Zone 6
            if (SetArrosageUp == 0)
            {
              t_z6 -= 1;
            }
            ...
            EEPROM.writeDouble(addr_t_z6, t_z6);
            P8_n9.setValue(t_z6);
          break;
    }
