...
float debit_pompe_chlore = 2.6 / 3600;   // débit en l/s (2.6 l/h)
float qte_hbdo = 0;
...
//    rtc.set(0, 5, 16, 3, 15, 2, 16);
      ...
      if(!SD.begin(4)) {
      dbSerialPrintln(F("Initialisation carte SD impossible !"));
      return;
      }
      dbSerialPrintln(F("Initialisation carte SD OK"));
