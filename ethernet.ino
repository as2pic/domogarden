    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.print("Temperature Ext: ");
          client.println(temp);
          client.println(" Deg C");
          client.println("<br />");
          client.print("Temperature Systeme: ");
          ...
          if ((start_z1 == 1) || (start_z2 == 1) || (start_z3 == 1) || (start_z4 == 1)){
              client.println("Cycle auto en marche");
              client.println("<br />");
              client.println("<font size=4>");
              client.println("Temps restant Z1");
              client.println("<br />");
              client.println(t_z1);
              client.println("<br />");
              client.println("Temps restant Z2");
              client.println("<br />");
              client.println(t_z2);
              client.println("<br />");
              client.println("Temps restant Z3");
              client.println("<br />");
              client.println(t_z3);
              client.println("<br />");
              client.println("Temps restant Z4");
              client.println("<br />");
              client.println(t_z4);
              client.println("<br />");
              client.println("</font>");
